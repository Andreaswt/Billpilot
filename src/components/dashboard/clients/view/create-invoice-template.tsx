...
import { Badge, Tooltip, Button, Select, Checkbox, Flex, FormControl, FormErrorMessage, FormLabel, Heading, HStack, Icon, IconButton, Input, InputGroup, InputLeftAddon, InputRightAddon, NumberDecrementStepper, NumberIncrementStepper, NumberInput, NumberInputField, NumberInputStepper, Stack, Text, Wrap } from '@chakra-ui/react'
import { Currency, InvoiceTemplateFilterTypes } from '@prisma/client'
import { Card, CardBody, Divider, useFieldArray, useForm, useSnackbar, FormLayout, CardTitle } from '@saas-ui/react'
                    ...
                    <CardBody>
                        <Stack gap={4}>
                            <Flex justifyContent="space-between">
                                ...
                                <Tooltip label="Active means that the template will be checked off by default, when using the invoice generator." aria-label='Active means that the template will be checked off by default, when using the invoice generator.'>
                                <Select
                                        id="active"
                                        {...register(`active`)}>
