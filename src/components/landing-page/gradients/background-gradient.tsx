...
export const BackgroundGradient = ({ hideOverlay, ...props }: any) => {
  ...
  const colors = [
    ...
    theme.colors.hero['left'],
    theme.colors.hero['right']
  ]

  let fallbackBackground = `radial-gradient(at top left, ${colors[2]} 30%, transparent 80%), radial-gradient(at bottom, ${colors[1]} 0%, transparent 60%), radial-gradient(at bottom left, var(--chakra-colors-cyan-500) 0%, transparent 50%),
