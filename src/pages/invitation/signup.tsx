...
const Signup: NextPage = () => {
  ...
  const { data, isLoading } = trpc.useQuery(["users.getInvitation", { id: invitationId }])
                  ...
                  isLoading || !data
                    ...
                    : <Container>
                      <Stack spacing={8} mx={"auto"} maxW={"lg"} py={12} px={6}>
                        ...
                        <Heading textAlign="center" color={useColorModeValue('gray.800', 'white')} fontSize="xl" zIndex='9999'>
                          You have been invited to join the organization {data.organization.name} on Billpilot.
                        </Heading>
                        <form onSubmit={handleSubmit(onSubmit)}>
                          <Stack spacing={4}>
                            ...
                            <FormControl isInvalid={!errors?.email?.message == false} id="email" isRequired>
                              ...
                              <Input defaultValue={data.email} type="email" {...register("email")} />
