          ...
          <Center>
            <Stack flex="1" direction="row">
              ...
              >
                ...
                <Heading size="md">4. USER REGISTRATION</Heading>
                <Heading size="md">5. FEES AND PAYMENT</Heading>
                <Heading size="md">6. FREE TRIAL</Heading>
                <Heading size="md">7. CANCELLATION</Heading>
                <Heading size="md">8. PROHIBITED ACTIVITIES</Heading>
                <Heading size="md">9. USER GENERATED CONTRIBUTIONS</Heading>
                <Heading size="md">10. CONTRIBUTION LICENSE</Heading>
                <Heading size="md">11. SUBMISSIONS</Heading>
                <Heading size="md">12. THIRD-PARTY WEBSITES AND CONTENT</Heading>
                <Heading size="md">13. U.S. GOVERNMENT RIGHTS</Heading>
                <Heading size="md">14. SITE MANAGEMENT</Heading>
                <Heading size="md">15. PRIVACY POLICY</Heading>
                <Heading size="md">16. TERM AND TERMINATION</Heading>
                <Heading size="md">17. MODIFICATIONS AND INTERRUPTIONS</Heading>
                <Heading size="md">18. GOVERNING LAW</Heading>
                <Heading size="md">19. DISPUTE RESOLUTION</Heading>
                <Heading size="md">20. CORRECTIONS</Heading>
                <Heading size="md">21. DISCLAIMER</Heading>
                <Heading size="md">22. LIMITATIONS OF LIABILITY</Heading>
                <Heading size="md">23. INDEMNIFICATION</Heading>
                <Heading size="md">24. USER DATA</Heading>
                <Heading size="md">25. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</Heading>
                <Heading size="md">26. CALIFORNIA USERS AND RESIDENTS</Heading>
                <Heading size="md">27. MISCELLANEOUS</Heading>
                <Heading size="md">28. CONTACT US</Heading>



                <Heading size="md">1. AGREEMENT TO TERMS</Heading>
                <Text>
                  These Terms of Service constitute a legally binding agreement made between you, whether personally or on behalf of an entity (“you”) and Billpilot.io ("Company", “we”, “us”, or “our”), concerning your access to and use of the billpilot.io website as well as any other media form, media channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the “Site”). We are registered in Scotland and have our registered office at 64/5 Thirlestane Rd., Edinburgh, Midlothian EH9 1AR. Our VAT number is Not yet registered. You agree that by accessing the Site, you have read, understood, and agree to be bound by all of these Terms of Service. IF YOU DO NOT AGREE WITH ALL OF THESE TERMS OF SERVICE, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SITE AND YOU MUST DISCONTINUE USE IMMEDIATELY.
                ...
                <Text>
                  ...
                  If you are unsatisfied with our services, please email us at contact@billpilot.io or call us at +447467721639.
                </Text>
                <Heading size="md">8. PROHIBITED ACTIVITIES</Heading>
                <Text>
                ...
                <Heading size="md">15. PRIVACY POLICY</Heading>
                <Text>
                  We care about data privacy and security. Please review our Privacy Policy: https://billpilot.io/privacypolicy. By using the Site, you agree to be bound by our Privacy Policy, which is incorporated into these Terms of Service. Please be advised the Site is hosted in the United States. If you access the Site from any other region of the world with laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws in the United States, then through your continued use of the Site, you are transferring your data to the United States, and you agree to have your data transferred to and processed in the United States.
                </Text>
                <Heading size="md">16. TERM AND TERMINATION</Heading>
                <Text>
                ...
                <Heading size="md">18. GOVERNING LAW</Heading>
                <Text>
                  These conditions are governed by and interpreted following the laws of the United Kingdom, and the use of the United Nations Convention of Contracts for the International Sale of Goods is expressly excluded. If your habitual residence is in the EU, and you are a consumer, you additionally possess the protection provided to you by obligatory provisions of the law of your country of residence. Billpilot.io and yourself both agree to submit to the non-exclusive jurisdiction of the courts of Edinburgh, which means that you may make a claim to defend your consumer protection rights in regards to these Conditions of Use in the United Kingdom, or in the EU country in which you reside.
                </Text>
                <Heading size="md">19. DISPUTE RESOLUTION</Heading>
                <Text>
                ...
                <Text>
                  ...
                  Billpilot.io
                  64/5 Thirlestane Rd.
                  Edinburgh, Midlothian EH9 1AR
                  Scotland
                  Phone: +447467721639
                  contact@billpilot.io
                </Text>
