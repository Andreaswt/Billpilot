          ...
          >
            ...
            <Center>
              ...
              <Grid
                ...
                />
                <Feature
                  svg={<svg height={'50px'} width={'50px'}><path fill-rule="evenodd" clip-rule="evenodd" d="M19.045 10c9.08.89 19.04 5.482 24.752 12.15 7.322 8.445 4.833 16.891-5.566 18.816-10.399 2.075-24.752-3.258-32.075-11.705C.59 22.741.737 16.223 5.863 12.667L34.715 34.3 19.045 10z" fill="#C92043"></path></svg>}
                  title={'E-Conomic'}
