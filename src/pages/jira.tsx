              ...
              <FallInPlace>
                ...
                <Box alignItems="center" justifyContent="center" pt='0px' bgGradient={colorMode === 'dark' ? 'linear(to-l, #68affb, #FFFFFF)' : 'linear(to-l, #68affb, #000)'} bgClip='text' h='max'>
                  ...
                  <Heading size='xl' fontWeight='400'>
                    Billpilot&apos;s Jira Plugin
                  </Heading>
                </Box>
              </FallInPlace>

              <Highlights p='0'>
                <HighlightsItem colSpan={[1, null, 3]} title="Jira Solution">
                  <Text>
                    If you use {' '}
                    <Link color='blue.500' href="https://www.Jira.com/">
                      Jira
                    </Link>
                    {' '} connect it with Billpilot to streamline your invoicing process.
                    How Billpilot integrates with Jira?
                ...
                <HighlightsItem colSpan={[1, null, 2]} title="Features">
                  <List spacing={3}>
                    <ListItem>
                      ...
                      Utilize autogenerated templates to invoice by the hour, issue or project
                    </ListItem>
                    <ListItem>
                      <ListIcon as={IoCheckmarkCircle} color='primary.400' />
                      Automate which issues are selected from Jira for invoicing
                    </ListItem>
                    <ListItem>
                      <ListIcon as={IoCheckmarkCircle} color='primary.400' />
                      Sync projects and issues from Jira
                    </ListItem>
                    <ListItem>
                      <ListIcon as={IoCheckmarkCircle} color='primary.400' />
                      One click set up
                ...
                <HighlightsItem title="One Click Setup" colSpan={[1, null, 1]}>
                  <Text color="muted" fontSize="lg">
                    Integrate Billpilot and Jira with a simple one click login process. Sync afterwards to start Invoicing.
                  </Text>
                </HighlightsItem>
                <HighlightsItem colSpan={[1, null, 3]} title="Billpilot Integrations for Jira" height="max">
